...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      {/* Hero Section */}
      <section id='home' className="pt-20 pb-16 md:pt-28 md:pb-24 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fade-in">
              ...
              <p className="text-lg text-[#64748B] leading-relaxed mb-8">
                SmartPharm helps you manage inventory, track loans, handle
                patients, and sync automatically when online. Perfect for modern
                pharmacy shops.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Link
                  to="/auth?mode=signup"
                  className="inline-flex items-center justify-center gap-2 bg-[#0F6E8A] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#0A4D62] hover:shadow-lg transition-all group"
                >
                  Start Free Trial
                  <ArrowRight
                    size={18}
                ...
                <Link
                  to="/contact"
                  className="inline-flex items-center justify-center gap-2 border border-[#E2E8F0] text-[#64748B] px-6 py-3 rounded-lg font-semibold hover:border-[#0F6E8A] hover:text-[#0F6E8A] transition-all"
                >
                  <Headphones size={18} />
                  Contact Support
                </Link>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-[#64748B] mb-6">
                Create professional invoices for both purchasing and selling.
                Track payments, manage customer details, and get real-time
            ...
            <div className="bg-white rounded-2xl p-6 border border-[#E2E8F0] shadow-lg">
              <div className="bg-[#F8FAFC] rounded-lg p-4 mb-4">
                <div className="flex justify-between items-center mb-3">
                  <span className="text-sm font-semibold text-[#0F6E8A]">
                    INV-2024-001
                  </span>
                  <span className="text-xs px-2 py-1 bg-[#10B981]/10 text-[#10B981] rounded">
                    Completed
                  </span>
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="text-lg text-[#64748B] mb-6">
                SmartPharm works completely offline. Add products, create
                invoices, and manage patients - everything saves locally and
            ...
            <div className="order-1 lg:order-2">
              <div className="bg-gradient-to-br from-[#0F6E8A]/5 to-[#48B5C5]/5 rounded-2xl p-8 border border-[#E2E8F0] shadow-lg">
                <div className="flex items-center justify-around">
                  ...
                  <div className="text-2xl text-[#0F6E8A] font-bold animate-pulse">
                    ⟷
                  </div>
      ...
      <section id="pricing" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="section-subtitle">
              Choose the plan that works for your pharmacy
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-[#0F6E8A] to-[#0A4D62] rounded-3xl p-8 md:p-12 text-center shadow-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
              <Link
                to="/auth?mode=signup"
                className="inline-flex items-center justify-center gap-2 bg-white text-[#0F6E8A] px-6 md:px-8 py-3 rounded-lg font-semibold hover:shadow-xl transition-all group"
              >
                Start Free Trial
                <ArrowRight
                  size={18}
              ...
              <Link
                to="/contact"
                className="inline-flex items-center justify-center gap-2 border-2 border-white/30 text-white px-6 md:px-8 py-3 rounded-lg font-semibold hover:bg-white/10 transition-all"
              >
                <Headphones size={18} />
                Contact Support
              </Link>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold">
                  Smart<span className="text-[#48B5C5]">Pharm</span>
                </span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-[#94A3B8]">
                ...
                <li>
                  <Link to="/assistant" className="hover:text-white transition">
                    AI Assistant
                  </Link>
                </li>
              </ul>
...
const PricingCard = ({
  ...
  return (
    <div
      className={`relative p-6 rounded-xl border transition-all hover:shadow-xl ${
        popular
